...
from Funciones_conexion import obtener_planta, obtener_plantas, registrar_usuario, verificar_usuario, obtener_comentarios, obtener_respuestas, registrar_comentario
